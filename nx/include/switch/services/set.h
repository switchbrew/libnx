...
typedef enum
{
    ...
    SetLanguage_ENUS =  1,  ///< US English
    SetLanguage_FR =    2,  ///< French
    SetLanguage_DE =    3,  ///< German
    SetLanguage_IT =    4,  ///< Italian
    SetLanguage_ES =    5,  ///< Spanish
    SetLanguage_ZHCN =  6,  ///< Simplified Chinese
    SetLanguage_KO =    7,  ///< Korean
    SetLanguage_NL =    8,  ///< Dutch
    SetLanguage_PT =    9,  ///< Portugese
    SetLanguage_RU =    10, ///< Russian
    SetLanguage_ZHTW =  11, ///< Traditional Chinese
    SetLanguage_ENGB =  12, ///< GB English
    SetLanguage_FRCA =  13, ///< CA French
    SetLanguage_ES419 = 14, ///< {?} Spanish
} SetLanguage;
